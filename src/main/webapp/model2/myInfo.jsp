...
<hr>
    <% if(m != null){ %>
<section id="myinfo">
    <form action="/model2/mupdate.lo" method="post">
        <table>
            <tr>
                <td>ID :</td>
        ...
        <p align="center">
            ...
            &nbsp; &nbsp;
            <button type="button"
                    onclick="location.href='/model2/mdelete.lo?id=<%=m.getId()%>';">회원 탈퇴</button>
        </p>
    </form>
</section>
<%} else { %>
<jsp:forward page="enroll.jsp"/>
<!-- 가입하지 않은 사용자가 접속할 경우 enroll.html로 forwarding -->
<% } %>
<br><br>
<p align="center">
    <button type="button" onclick="location.href='/model2/index.jsp';">메인으로가기</button>
</p>
</body>
</html>